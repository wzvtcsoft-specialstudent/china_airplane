<template>
  <!-- <div id="app"> -->
    <div id="pic6" style="width: 100%; height: 100%"></div>
  <!-- </div> -->
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    drawChart () {
      ...
      const geoCoordMap = {
        ...
        韶关: [113.7964, 24.7028],
        浙江: [120.7964, 28.7028],
        内蒙古:[109.8586, 41.1775],
        河北: [115.4219, 38.4189],
        辽宁:[122.8586, 41.1775],
        吉林:[126.5586, 42.9775],
        黑龙江:[128.5586, 46.9775],
        山西: [112.4219, 37.4189],
        甘肃: [97.4038, 39.8207],
        新疆: [85.4038, 39.8207],
        西藏: [85.4038, 32.8207],
      ...
      var XAData = [
        [{ name: '北京' }, { name: '浙江', value: 100 }],
        [{ name: '北京' }, { name: '天津', value: 100 }],
        [{ name: '北京' }, { name: '广州', value: 100 }],
        [{ name: '北京' }, { name: '青海', value: 100 }],
        [{ name: '北京' }, { name: '宁夏', value: 100 }],
        [{ name: '北京' }, { name: '山东', value: 100 }],
        [{ name: '北京' }, { name: '内蒙古', value: 100 }],
        [{ name: '北京' }, { name: '河北', value: 100 }],
        [{ name: '北京' }, { name: '辽宁', value: 100 }],
        [{ name: '北京' }, { name: '吉林', value: 100 }],
        [{ name: '北京' }, { name: '黑龙江', value: 100 }],
        [{ name: '北京' }, { name: '山西', value: 100 }],
        [{ name: '北京' }, { name: '甘肃', value: 100 }],
        [{ name: '北京' }, { name: '新疆', value: 100 }],
        [{ name: '北京' }, { name: '西藏', value: 100 }],
        [{ name: '北京' }, { name: '四川', value: 100 }],
        [{ name: '北京' }, { name: '云南', value: 100 }],
        [{ name: '北京' }, { name: '广西', value: 100 }],
      ...
      var color = ['#46bee9', '#ffa022', '#46bee9'] // 航线的颜色
      var series = []
      ;[
        ['北京', XAData],
        // ['西宁', XNData],
  ...
  watch:{
   ...
   let formData = new FormData();
    //参数
   formData.append("province",newval);
  ...
  this.$http.post("http://192.168.193.209:8000/index/", formData, config).then((res) => {
   ...
   for (let index = 0; index < store.length; index++) {
     ...
     sortie.push(obj1)
     var obj2=store[index][3]
     throughput.push(obj2)
   }
